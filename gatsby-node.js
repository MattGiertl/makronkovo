...
exports.createPages = async ({ actions, graphql, reporter }) => {
  ...
  createPage({
    ...
    context: {
      ...
      lowerText:
        'Dezerty Vám radi dovezieme chladiarenským autom a naaranžujeme v štýle Vašej svadby/akcie. Ohúrte Vašich hostí nie len skvelou chuťou ale aj vizuálnym zážitkom. Ceny dostupné na vyžiadanie.',
